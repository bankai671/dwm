...
static const char col_red1[] 				= "#371110";
static const char col_red2[]        = "#951313";
static const char *colors[][3]      = {
	/*               fg         bg         border   */
	[SchemeNorm] = { col_gray3, col_gray1, col_gray2 },
	[SchemeSel]  = { col_gray4, col_red1,  col_gray3 },
};
...
static const char *dmenucmd[] = { "dmenu_run", "-m", dmenumon, "-fn", dmenufont, "-nb", col_gray1, "-nf", col_gray3, "-sb", col_red1, "-sf", col_gray4, "-b", NULL };
...
static const char *scrotcmd[]    		= { "/usr/bin/scrot", "-z", "/home/bankai/stuff/screenshots/%Y-%m-%d-%T-screenshot.png", "-e", xclipimg, NULL };
static const char *scrotselectcmd[] = { "/usr/bin/scrot", "-z", "-s", "-l", "mode=edge", "/home/bankai/stuff/screenshots/%Y-%m-%d-%T-screenshot.png", "-e", xclipimg, NULL };
...
static const Key keys[] = {
	...
	{ ShiftMask, 								XK_Print,		  			spawn,  				 {.v = scrotselectcmd } },
};
